...
from PyQt5.QtCore import QThread, QSettings, pyqtSlot
from PyQt5.QtWidgets import QMainWindow, QApplication, qApp, QDialog, QFileDialog, QMessageBox, QListWidgetItem
